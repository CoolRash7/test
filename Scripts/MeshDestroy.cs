...
public class MeshDestroy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        mySize = Globals.getSizeGameObject(gameObject);
    ...
    private void DestroyMesh()
    {
        ...
        if (Globals.getSizeGameObject(gameObject) >= 0)
        {
            ...
            Debug.Log("Very small - cant destory: " + Globals.getSizeGameObject(gameObject) );
